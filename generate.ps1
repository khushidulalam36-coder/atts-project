...
<body>
  ...
  if (data.token) {
    ...
    // প্রথমে প্যানেল না দেখিয়ে ডেটা লোড করি
    ...
    if (stats && !stats.error) {
      ...
      // সরাসরি showSection কল করার বদলে আগে ড্যাশবোর্ড রেন্ডার করি
      loadDashboardWithData(stats); // আমরা একটি হেল্পার ফাংশন ব্যবহার করব
    } else {
      // ব্যর্থ হলে আবার লগইন ফর্ম দেখাই
...
// হেল্পার ফাংশন — loadDashboard কে সরাসরি ডাটা দিয়ে কল
function loadDashboardWithData(data) {
  ...
  // বর্তমান সেকশন হিসেবে ড্যাশবোর্ড সেট
